...
const CampusLifeSection: React.FC = () => {
  return (
    <section className="relative w-full h-[500px] md:h-[600px] flex items-center justify-center bg-gray-900">
      {/* Quick Links Bar */}
      <div className="absolute top-0 left-0 w-full bg-blue-900 text-white flex items-center px-8 py-3 gap-8 z-20">
